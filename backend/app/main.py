...
from .api import admin_config, ai, auth, chat, document, exam, exam_running, gen_doc, hazard, log, paper, user, user_paper
...
app.include_router(hazard.category_router)
app.include_router(user_paper.router)
app.include_router(user.router)
app.include_router(log.router)
app.include_router(document.router)
app.include_router(admin_config.router)
app.include_router(gen_doc.router)
